...
- revert the following Git commits from Jul 3, 2020

| commit                                                                                                | comment                                                                          |
| ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| [ae18ba4](https://github.com/intershop/intershop-pwa/commit/ae18ba4aef77d1841552597fbfc89a17eaa17e9a) | feat: switch to the new headless REST application type CMS content model         |
| [b0d3213](https://github.com/intershop/intershop-pwa/commit/b0d321324f947cf4c6cdb05230518c711af43ac6) | feat: switch to the new headless REST application type applications demo content |
